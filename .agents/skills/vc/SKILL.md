...
- Do **not** append **tool marketing trailers** to commit messages (e.g. “Made with Cursor”, “Generated by …”).
- Do **not** add **`Co-authored-by:`** git trailers for assistants or tools unless the **human** author explicitly requests recorded co-authorship; keep collaboration context in the PR or issue if it matters.

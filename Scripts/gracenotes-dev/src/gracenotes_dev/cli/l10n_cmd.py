...
DYNAMIC_TEMPLATE_KEYS = frozenset(
    {
        ...
        # Curated Past theme chips: keys built in ReviewThemeConceptEngine.catalogKey (issue #245).
        "review.theme.boundaries",
        "review.theme.calm",
        "review.theme.creativity",
        "review.theme.dad",
        "review.theme.daily_rhythm",
        "review.theme.family_connection",
        "review.theme.financial_pressure",
        "review.theme.focus",
        "review.theme.friendship",
        "review.theme.home_care",
        "review.theme.learning",
        "review.theme.mom",
        "review.theme.movement",
        "review.theme.nature",
        "review.theme.parenting",
        "review.theme.partner_connection",
        "review.theme.personal_time",
        "review.theme.quiet_time",
        "review.theme.rest",
        "review.theme.scripture",
        "review.theme.sleep",
        "review.theme.therapy",

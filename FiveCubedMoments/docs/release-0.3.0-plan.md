...
- [ ] **Reminders** — Optional daily notification to complete today's 5³. UserNotifications, settings toggle + time picker, UserDefaults persistence. (See `.cursor/plans/next_step_for_app_86920bfa.plan.md`.)
...
- [ ] **Home screen widget** — Widget showing today's 5³ summary (e.g., completion status or preview).

...
- `GraceNotes/docs/agent-log/initiatives/archive/004-issue-36-37-input-pipeline-stabilization/architecture.md` (staged #31/#33 as follow-up)
- `GraceNotes/docs/agent-log/initiatives/archive/003-issue-31-33-launch-toggle-performance/architecture.md` (proposed technical approach)
